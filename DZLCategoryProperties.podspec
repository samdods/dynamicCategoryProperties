#
#  Be sure to run `pod spec lint DZLCategoryProperties.podspec' to ensure this is a
...
Simply declare your category properties as `@dynamic` and call one of the implementor methods from the `+load` method of your category.
  ...
  # s.authors      = { "Sam Dods" => "sam@theappbusiness.com", "other author" => "email@address.com" }
  # s.author       = 'Sam Dods', 'other author'
